...
const Footer = () => {
  return (
      ...
      <footer className="footer p-10 bg-base-300 text-yellow-500 bottom-0">
        <div className="flex items-center space-x-4">
          ...
          <p className="text-lg font-semibold">
            <span className="font-bold bg-gradient-to-r from-rose-700 via-rose-500 to-rose-300 bg-clip-text text-transparent text-xl">GeekMatch Ltd.</span>
            <br />
    ...
    <a className="link link-hover" href='https://merchant.razorpay.com/policy/PlGBSxfziRx1U9/contact_us' target='_blank' >Contact Us</a>
        ...
        <nav>
          <h6 className="footer-title text-xl font-bold bg-gradient-to-r from-rose-700 via-rose-500 to-rose-300 bg-clip-text text-transparent">Connect With Us</h6>
